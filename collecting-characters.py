...
while True:
    _, frame = cap.read()
    # Simulating mirror image (flipping around Y-axis)
    ...
    # cv2.rectangle(frame, (220-1, 9), (620+1, 419), (255,0,0) ,1)  ORIGINAL
    cv2.rectangle(frame, (330, 10), (630, 310), (255,0,0) ,1)


    # Extracting the ROI
    # roi = frame[10:410, 220:520] ORIGINAL
    roi = frame[10+2:310, 330+2:630]
    ...
    # test_image = cv2.Canny(roi,80,150)
